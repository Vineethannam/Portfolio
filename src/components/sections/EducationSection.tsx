    ...
    <div className="bg-myColor rounded-xl p-6 mb-6">
      <div className="mb-10">
        ...
        <div className="space-y-8">
          ...
          <div className="relative pl-6 border-l-2 border-[#333333]">
            <div className="absolute w-3 h-3 bg-HeighLightColor rounded-full -left-[7px] top-1"></div>
            <h4 className="font-semibold">Bachelor of Arts in Visual Communication</h4>
            <p className="text-sm text-HeighLightColor mb-2">California Institute of the Arts • 2008 - 2012</p>
            <p className="text-sm text-myText mb-4">
              Comprehensive education in visual design principles, typography, color theory, and digital media. Graduated summa cum laude.
            </p>
            <div className="bg-[#2a2a2a] rounded-lg p-4">
              ...
              <ul className="text-sm text-myText space-y-2 list-disc pl-5">
                ...
                <li>User Interface Design Fundamentals</li>
          ...
          <div className="relative pl-6 border-l-2 border-[#333333]">
            <div className="absolute w-3 h-3 bg-HeighLightColor rounded-full -left-[7px] top-1"></div>
            <h4 className="font-semibold">Certificate in Web Development</h4>
            <p className="text-sm text-HeighLightColor mb-2">Tech Academy • 2011</p>
            <p className="text-sm text-myText mb-4">
              Intensive 6-month program focused on front-end development technologies and responsive design principles.
            </p>
            <div className="bg-[#2a2a2a] rounded-lg p-4">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                ...
                <span className="px-3 py-1 bg-[#333333] rounded-full text-xs">jQuery</span>
